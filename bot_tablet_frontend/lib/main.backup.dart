...
//     await client.engine.setChannelProfile(ChannelProfile.LiveBroadcasting);
//     await client.engine.setClientRole(ClientRole.Broadcaster);
//     await client.engine.startPreview(); // added
//     await client.engine.enableFaceDetection(true); // added
...
//             faces = faces.where((face) => face.width > 100).toList();
...
//     /* -------------------------------------------------------------------------- */
//     await client.sessionController.joinVideoChannel();
//     // await client.engine
//     //     .joinChannel("e7c5b65f9465479eb7eda9ce4490c897", "touri", null, 0);
//   }
